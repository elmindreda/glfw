...
#include "null_platform.h"
 ...
 #define GLFW_WGL_FRAMEBUFFER_STATE
 ...
 #define GLFW_NSGL_FRAMEBUFFER_STATE
 ...
 #define GLFW_GLX_FRAMEBUFFER_STATE
...
#define GLFW_PLATFORM_FRAMEBUFFER_STATE \
        GLFW_WGL_FRAMEBUFFER_STATE \
        GLFW_NSGL_FRAMEBUFFER_STATE \
        GLFW_GLX_FRAMEBUFFER_STATE
