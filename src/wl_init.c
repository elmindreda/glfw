...
#define types _glfw_alpha_modifier_types
#include "alpha-modifier-v1-client-protocol-code.h"
#undef types
...
void _glfwTerminateWayland(void)
{
    ...
    if (_glfw.wl.alphaModifierManager)
        wp_alpha_modifier_v1_destroy(_glfw.wl.alphaModifierManager);
